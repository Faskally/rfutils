...
#' @param model detail
#' @param scope detail
#' @param smoothTerms detail
#' @param notLinear detail
#' @param essential detail
#' @param criterion detail
#' @param cluster  detail
#' @param byExpand  detail
#' @param calcLogLik detail
